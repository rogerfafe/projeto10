		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Projeto Dez",
									"targetURL": "#brcomprojeto10projeto10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomprojeto10projeto10-display": {
								"semanticObject": "brcomprojeto10projeto10",
								"action": "display",
								"description": "Projeto 10 Roger",
								"title": "Projeto Dez",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.projeto10.projeto10",
									"url": sap.ui.require.toUrl("br/com/projeto10/projeto10")
								}
							}
						}
					}
